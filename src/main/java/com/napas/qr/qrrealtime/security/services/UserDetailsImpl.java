...
public class UserDetailsImpl implements UserDetails {
    ...
    public UserDetailsImpl(Long id, String username, String password,
            Collection<? extends GrantedAuthority> authorities, ETargetType targetType, Long targetId) {
        this.id = id;
    ...
    public static UserDetailsImpl build(TblOrgUser user) {
        SimpleGrantedAuthority simpleRole = new SimpleGrantedAuthority(user.getRole().toString());
        ...
        return new UserDetailsImpl(
                ...
                user.getUsername(),
                user.getPassword(),
                listRoles, user.getTargetType(), user.getTargetId());
    }
